	...
	<div id="wrapper">
		...
		<div id="contents">
			<div class="container">
				...
				<div class="contents">
					<form method="POST" action="MascotaController">
						<p>
							<label for="nro_historia_clinica"> Historia clínica:</label> <input
            ...
            value="${mascota.getFechaNacimiento() }" />"
						...
						<p>
							<label for="nombre_duenio"> Nombre del dueño:</label> <input
								type="text" name="nombre_duenio"
								value="${mascota.getDuenio().getNombre()}" readonly="readonly" />
						</p>
						<p>
							<label for="dni_duenio"> DNI del dueño:</label> <input
						...
						<p>
							<label for="e_mail"> Correo electrónico:</label> <input
